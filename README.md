...
詳しいインストール方法とビルド方法は、[導入ガイド](docs/GETTING_STARTED.md)を参照してください。
...
詳しくは、[スナップショットと走査範囲](docs/SNAPSHOTS_AND_SCANNING.md)を参照してください。
...
詳しい使い方は、[分析ガイド](docs/ANALYSIS_GUIDE.md)を参照してください。
...
保存内容や設定ファイルの詳細は、[設定と保存場所](docs/CONFIGURATION_AND_STORAGE.md)を参照してください。

## ドキュメント

| 文書 | 内容 |
|---|---|
| [ドキュメント一覧](docs/README.md) | 目的に合う文書を探す |
| [導入ガイド](docs/GETTING_STARTED.md) | インストール、基本用語、最初の操作 |
| [スナップショットと走査範囲](docs/SNAPSHOTS_AND_SCANNING.md) | 権限、除外、NFS、autofs、マウントポイント |
| [分析ガイド](docs/ANALYSIS_GUIDE.md) | 容量、差分、放置候補、許容量、ユーザー、ファイル、inode |
| [設定と保存場所](docs/CONFIGURATION_AND_STORAGE.md) | 設定ファイル、プロファイル、状態データ |
| [運用と保守](docs/OPERATIONS.md) | 検証、修復、圧縮、しきい値、定期実行、終了コード |
| [トラブルシューティング](docs/TROUBLESHOOTING.md) | よくあるエラーと確認手順 |
...
全オプションは`--help`または[コマンドリファレンス](docs/COMMAND_REFERENCE.md)で確認できます。
