...
| Document | Purpose |
|---|---|
| [Documentation index](docs/README_en.md) | Find the appropriate guide |
| [Getting started](docs/GETTING_STARTED_en.md) | Installation and first workflow |
| [Snapshots and scanning](docs/SNAPSHOTS_AND_SCANNING_en.md) | Permissions, exclusions, mounts, NFS, and autofs |
| [Analysis guide](docs/ANALYSIS_GUIDE_en.md) | Rankings, diffs, users, files, inodes, and staleness |
| [Configuration and storage](docs/CONFIGURATION_AND_STORAGE_en.md) | Profiles, XDG files, and snapshot state |
| [Operations](docs/OPERATIONS_en.md) | Verification, repair, compaction, checks, and exit codes |
| [Troubleshooting](docs/TROUBLESHOOTING_en.md) | Common failures and diagnostics |
| [Command reference](docs/COMMAND_REFERENCE_en.md) | Commands and option families |
| [Development](docs/DEVELOPMENT_en.md) | Tests, quality checks, CI, security, and layout |
| [Weekly snapshots with tmux](docs/QDU_TMUX_WEEKLY_SNAPSHOT_GUIDE_en.md) | Scheduling without cron |
